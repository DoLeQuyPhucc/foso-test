...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-100 text-gray-800 border-t">
      {/* Main Footer Content */}
      <div className="mx-auto py-6 px-[15%]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Sitemap */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-800">Sitemap</h3>
            ...
            <div className="space-y-3">
              ...
              <div>
                <a href="#" className="block">
                  <div className="bg-black text-white rounded-lg px-4 py-2 flex items-center gap-3 hover:bg-gray-800 transition-colors w-fit">
